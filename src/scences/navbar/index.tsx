...
const Navbar = ({ selectedPage, setSelectedPage,isTopPage }: Props) => {
  ...
  const navbarBackGroundColor=isTopPage?"":"bg-primary-100 drop-shadow";
  ...
  return (
    <nav>
      ...
      {!isAboveMediumScreens && isMenuToggled && (
        ...
        <div className="fixed right-0 bottom-9 z-40 h-full w-[300px] bg-primary-100 drop-shadow-xl">
          {/* close icon */}
